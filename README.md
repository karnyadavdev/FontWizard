Note: Use Brave browser instead of edge, on some websites some thin text uses default font in edge, everywhere else it still works ,its edge specific issue</br>
